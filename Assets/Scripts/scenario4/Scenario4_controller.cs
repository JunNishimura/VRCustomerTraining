...
public class Scenario4_controller : MonoBehaviour
{
    ...
    public GameObject table1_customer1;
    public GameObject table1_customer2;
    ...
    public GameObject table6_customer1;
    ...
    Animator animator_table1_customer1;
    Animator animator_table1_customer2;
    ...
    Animator animator_table6_customer1;
    ...
    void Start()
    {
        ...
        animator_table1_customer1 = table1_customer1.GetComponent<Animator>();
        animator_table1_customer2 = table1_customer2.GetComponent<Animator>();
        ...
        animator_table6_customer1 = table6_customer1.GetComponent<Animator>();
        ...
        //ガイド・ヒントパネルの内容記述
        UIManager.Instance.guide.text = scenarioList.sheets[4].list[0].guide;
       ...
       "操作方法\n" +
        ...
        for (int i = 1; i < 4; i++)
        {
            speechRecognitionTable.Add($"4_{i}", "");
        }
    ...
    void Update()
    {
        ...
        {
            if(jobcompleted == false && FlagManager.Instance.flags[0] == false) GuidePanelUpdate(4, 1);

            if (FlagManager.Instance.flags[0] == false)
            {
                jobcompleted = true;

                UIManager.Instance.ordertable.text = "2番：ピザ、ハンバーガーセット";
                food1.SetActive(true);
                food2.SetActive(true);
                RaiseHands(animator_table4_customer1, true);
                t1 = time;
                //jobcompleted = true;

            }

            if(!entercube5.GetObjectName().Contains("Plate") && !entercube5.GetObjectName().Contains("PlateA"))
            {
                        ...
                        if (FlagManager.Instance.flags[1] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("4-1");
                                    GuidePanelUpdate(4,2);
                                    dialogue_counter += 1;
                                ...
                                case 1:
                                    AudioManager.Instance.PlayVoice("4-2");
                                    GuidePanelUpdate(4,3);
                                    dialogue_counter = 0;
                                    counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
        ...
        if (entercube4.GetEnter() == 1)
        {
            ...
            if (FlagManager.Instance.flags[0] == true && FlagManager.Instance.flags[1] == false 
                && FlagManager.Instance.flags[7] == false && jobcompleted == false)
            {
                GuidePanelUpdate(4,13);
                jobcompleted = true;
            }
            ...
            if (CameraDirected(table4_customer1) == true || CameraDirected(table4_customer2) == true)
            {
                if (Speech_Recognition_Manager.rec_complete == true) 
                {
                    if (FlagManager.Instance.flags[0] == true && FlagManager.Instance.flags[1] == false && FlagManager.Instance.flags[7] == false)
                    {
                        AUpdate(true);
                    }
                    ...
                    if (OVRInput.GetDown(OVRInput.RawButton.A))
                    {
                        if (FlagManager.Instance.flags[0] == true && FlagManager.Instance.flags[1] == false && FlagManager.Instance.flags[2] == false)
                        {
                            AUpdate(false);
                            BUpdate(true);
                            AudioManager.Instance.PlayVoice("4-10");
                            RaiseHands(animator_table4_customer1, false);
                            FlagManager.Instance.flags[7] = true;
                            GuidePanelUpdate(4,14);
                        }
                        else if (FlagManager.Instance.flags[2] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("4-3");
                                    GuidePanelUpdate(4,4);
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                ...
                                case 1:
                                    AudioManager.Instance.PlayVoice("4-4");
                                    GuidePanelUpdate(4,5);
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                ...
                                case 2:
                                    AudioManager.Instance.PlayVoice("4-5");
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                    GuidePanelUpdate(4,6);

                                    break;

                                case 3:
                                    AudioManager.Instance.PlayVoice("4-6");
                                    Speech_Recognition_Manager.rec_complete = false;
                                    GuidePanelUpdate(4,7);
        ...
        {
            if (FlagManager.Instance.flags[2] == false && FlagManager.Instance.flags[1] == true && jobcompleted == false)
            {
                GuidePanelUpdate(4,15);
                jobcompleted = true;
                
            }

            if (entercube1.GetObjectName().Contains("Pizza (1)") && FlagManager.Instance.flags[3] == true && FlagManager.Instance.flags[4] == false && jobcompleted == false)
            {
                GuidePanelUpdate(4,10);
                jobcompleted = true;
            }

            if (CameraDirected(table1_customer1) == true || CameraDirected(table1_customer2) == true)
            {
                //音声認識完了、Aボタン入力
                if (Speech_Recognition_Manager.rec_complete == true)
                {
                    if (FlagManager.Instance.flags[2] == false && FlagManager.Instance.flags[1] == true && FlagManager.Instance.flags[8] == false)
                    {
                        AUpdate(true);
                    }
                    ...
                    else if (FlagManager.Instance.flags[3] == true && FlagManager.Instance.flags[4] == false && entercube1.GetObjectName().Contains("Pizza (1)"))
                    {
                        AUpdate(true);
                    }
                    else
                    ...
                    if (OVRInput.GetDown(OVRInput.RawButton.A))
                    {
                        if (FlagManager.Instance.flags[2] == false && FlagManager.Instance.flags[1] == true)
                        {
                            AUpdate(false);
                            BUpdate(true);
                            AudioManager.Instance.PlayVoice("4-8");
                        ...
                        else if (FlagManager.Instance.flags[3] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("4-7");
                                    GuidePanelUpdate(4,8);
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                        ...
                        else if (FlagManager.Instance.flags[3] == true && FlagManager.Instance.flags[4] == false && entercube1.GetObjectName().Contains("Pizza (1)"))
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("4-9");
                                    //UIManager.Instance.guide.text = scenarioList.sheets[4].list[4].guide;
                                    dialogue_counter = 0;
                                    counter++;
                                    Speech_Recognition_Manager.rec_complete = false;
        ...
        //接客終了した場合の処理
        if (FlagManager.Instance.flags[5] == true && finished == false)
        {
            //GuidePanelUpdate(3,12);
            ...
            UIManager.Instance.result.text += "\n4番のお客様を待たせた時間：" + (int)t1 / 60 + "分" + (int)t1 % 60 + "秒\n";
            UIManager.Instance.result.text += "1番のお客様を待たせた時間：" + (int)t2 / 60 + "分" + (int)t2 % 60 + "秒\n";
            ...
            if (FlagManager.Instance.flags[10] == true)
            {
                ...
                UIManager.Instance.evaluation.text += "接客順序を間違えています。\n" +
                    "業務は素早くこなせるもの、呼び出された順番にこなしましょう。\n";
            }

            if(FlagManager.Instance.flags[7] == false && FlagManager.Instance.flags[8] == false)
            {
                UIManager.Instance.evaluation.color = new Color(1.0f, 0.27f, 0.27f, 1.0f);
                UIManager.Instance.evaluation.text += "1番テーブルと4番テーブルへの声掛けを忘れています。\n" +
                   "お客さんを順番待ちさせてしまう場合には、お待たせすることを伝えましょう。\n";
            }
            else if (FlagManager.Instance.flags[7] == false)
            {
                UIManager.Instance.evaluation.color = new Color(1.0f, 0.27f, 0.27f, 1.0f);
                UIManager.Instance.evaluation.text += "4番テーブルへの声掛けを忘れています。\n" +
                   "お客さんを順番待ちさせてしまう場合には、お待たせすることを伝えましょう。\n";
            }
            else if (FlagManager.Instance.flags[8] == false)
            {
                UIManager.Instance.evaluation.color = new Color(1.0f, 0.27f, 0.27f, 1.0f);
    ...
    private void OnApplicationQuit()
    {
        ...
        StreamWriter speechFile = new StreamWriter("D:/Documents/experiment/SpeechRecognition4.csv", true, enc);
