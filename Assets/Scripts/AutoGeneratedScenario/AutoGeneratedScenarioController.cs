                            ...
                            if (OVRInput.GetDown(OVRInput.RawButton.A))
                            {
                                ...
                                switch (_dialogueProgressList[scenarioNum])
                                {
                                    ...
                                    case 1:
                                        ...
                                        {
                                            case "サンドウィッチセット":
                                                voiceFileName = "sandwitch";
                                                break;
                                            case "ピザ":
                                                voiceFileName = "pizza";
                                                break;
                                            case "パンケーキ":
                                                voiceFileName = "pancake";
                                                break;
                                            case "ハンバーガーセット":
                                                voiceFileName = "hamburger";
                                                break;
                                            case "チョコレートケーキ":
                                                voiceFileName = "chocolatecake";
                                                break;
                                            case "バゲットセット":
                                                voiceFileName = "baguette";
                                                break;
                                            default:
                                                voiceFileName = "";
                                                break;
                                ...
                                if (OVRInput.GetDown(OVRInput.RawButton.A))
                                {
                                    ...
                                    switch (_dialogueProgressList[scenarioNum])
                                    {
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            AudioManager.Instance.PlayVoice("2-5"); // 音声「はい」
                        ...
                        else
                        {
                            ...
                            if (OVRInput.GetDown(OVRInput.RawButton.A))
                            {
                                ...
                                switch (_dialogueProgressList[scenarioNum])
                                {
                                    case 0:
                                        _animators[tableNum].SetBool("updown", false); // 手を下げる
                                        AudioManager.Instance.PlayVoice("complain1"); // 音声「すみません、ちょっといいですか」
                                        GuidePanelUpdate(5, 18); // パネル「お客様の話を聞きましょう」
                                        _dialogueProgressList[scenarioNum] += 1; // 会話の進行

                                        break;
                                    case 1:
                                        AudioManager.Instance.PlayVoice("complain2"); // 音声「先程の店員の接客態度が悪かったのですが」
                                        GuidePanelUpdate(5, 19); // パネル「謝罪して、後ほど注意しておくよう伝えましょう」
                                        _dialogueProgressList[scenarioNum] += 1; // 会話の進行

                                        break;
                                    case 2:
                                        AudioManager.Instance.PlayVoice("complain3"); // 音声「はい、以後気を付けてください」
