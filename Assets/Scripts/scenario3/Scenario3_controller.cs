...
public class Scenario3_controller : MonoBehaviour
{
    ...
    public GameObject table6_customer2;
   // public GameObject entrance_customer;
    ...
    Animator animator_table6_customer2;
    ...
    void Start()
    {
        ...
        animator_table6_customer2 = table6_customer2.GetComponent<Animator>();
        ...
        UIManager.Instance.guide.text = scenarioList.sheets[3].list[0].guide;
       ...
       "操作方法\n" +
        ...
        for (int i = 1; i < 5; i++)
        {
            speechRecognitionTable.Add($"3_{i}", "");
        }
    ...
    void Update()
    {
                        ...
                        if (FlagManager.Instance.flags[0] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("3-1");
                                    GuidePanelUpdate(3,1) ;
                                    dialogue_counter += 1;
                                ...
                                case 1:
                                    AudioManager.Instance.PlayVoice("3-2");
                                    GuidePanelUpdate(3,2) ;
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                ...
                                case 2:
                                    AudioManager.Instance.PlayVoice("3-3");


                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                    GuidePanelUpdate(3,3) ;

                                    break;

                                case 3:
                                    AudioManager.Instance.PlayVoice("3-4");
                                    Speech_Recognition_Manager.rec_complete = false;
                                    GuidePanelUpdate(3,4) ;
                                    ...
                                    //料理配膳の発生
                                    UIManager.Instance.ordertable.text = "3番:パンケーキ、バゲットセット\n";
        ...
        //table6
        if (entercube6.GetEnter() == 1)
        {
            if (FlagManager.Instance.flags[1] == false && jobcompleted == false)
            {
                GuidePanelUpdate(3,5);
                jobcompleted = true;
            }
           

            if (CameraDirected(table6_customer1) == true || CameraDirected(table6_customer2) == true)
            {
                if (Speech_Recognition_Manager.rec_complete == true) 
                {
                        ...
                        if (FlagManager.Instance.flags[1] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("3-5");
                                    GuidePanelUpdate(3,6);
                                    dialogue_counter = 0;
                                    counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                    ...
                                    animator_table6_customer2.SetBool("laughing", true);
        ...
        */
                        ...
                        if (FlagManager.Instance.flags[2] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                ...
                                case 0:
                                    ...
                                    if (entercube3.GetObjectName().Contains("Pancakes") && entercube3.GetObjectName().Contains("Baguette"))
                                    {
                                        t1 = time - t1;
                                        AudioManager.Instance.PlayVoice("3-6");
                                        GuidePanelUpdate(3,7);
                                        dialogue_counter += 1;
                                    ...
                                    else if (entercube3.GetObjectName().Contains("Pancakes") || entercube3.GetObjectName().Contains("Baguette"))
                                    {
                                        //もう一つの料理はまだ
                                        AudioManager.Instance.PlayVoice("3-6");
                                    }
                                ...
                                case 1:
                                    ...
                                    if (entercube3.GetObjectName().Contains("Pancakes") && entercube3.GetObjectName().Contains("Baguette"))
                                    {
                                        AudioManager.Instance.PlayVoice("3-7");
                                        GuidePanelUpdate(3,8);
                                        dialogue_counter = 0;
                                        counter += 1;
                                        Speech_Recognition_Manager.rec_complete = false;
        ...
        if (entercube5.GetEnter() == 1)
        {
            if (CameraDirected(table5_customer1) == true)
            {
                if (FlagManager.Instance.flags[1] == true && FlagManager.Instance.flags[2] == false 
                    && FlagManager.Instance.flags[3] == false && jobcompleted == false)
                {
                    //お待たせする声掛け判定
                    GuidePanelUpdate(3,14);
                    jobcompleted = true;
                ...
                if (Speech_Recognition_Manager.rec_complete == true)
                {
                    if (FlagManager.Instance.flags[3] == false && FlagManager.Instance.flags[2] == false && FlagManager.Instance.flags[6] == false)
                    {
                        AUpdate(true);
                    }
                    ...
                    if (OVRInput.GetDown(OVRInput.RawButton.A))
                    {
                        if (FlagManager.Instance.flags[3] == false && FlagManager.Instance.flags[2] == false)
                        {
                            ...
                            AudioManager.Instance.PlayVoice("3-10");
                            FlagManager.Instance.flags[6] = true;
                            GuidePanelUpdate(3,15);
                        }
                        else if (FlagManager.Instance.flags[3] == false)
                        {
                            ...
                            switch (dialogue_counter)
                            {
                                case 0:
                                    ...
                                    AudioManager.Instance.PlayVoice("3-8");
                                    GuidePanelUpdate(3,9) ;
                                    dialogue_counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
                                ...
                                case 1:
                                    AudioManager.Instance.PlayVoice("3-9");
                                    GuidePanelUpdate(3,10);
                                    Speech_Recognition_Manager.rec_complete = false;
                                ...
                                case 2:
                                    ...
                                    AudioManager.Instance.PlayVoice("3-10");
                                    //UIManager.Instance.guide.text = scenarioList.sheets[3].list[12].guide;
                                    dialogue_counter = 0;
                                    counter += 1;
                                    Speech_Recognition_Manager.rec_complete = false;
        ...
        if (FlagManager.Instance.flags[4] == true && finished == false)
        {
            ...
            UIManager.Instance.result.text += "料理配膳をするまでに経過した時間：" + (int)t1 / 60 + "分" + (int)t1 % 60 + "秒\n";
            ...
            if (FlagManager.Instance.flags[10] == true)
            {
                ...
                UIManager.Instance.evaluation.text += "接客順序を間違えています。\n" +
                    "業務は素早くこなせるもの、呼び出された順番にこなし、クレームはいち早く対応しましょう\n";
            }
    ...
    private void OnApplicationQuit()
    {
        ...
        StreamWriter speechFile = new StreamWriter("D:/Documents/experiment/SpeechRecognition3.csv", true, enc);
